  ...
  return (
    <section ref={sectionRef} id="approach" className={`approach-section ${isVisible ? 'approach-section--visible' : ''}`}>
      ...
      <div className="container">
        ...
        {/* Revolutionary Techniques Showcase */}
        <div className="techniques-showcase">
          <div className="techniques-showcase__header">
            <h3>Revolutionary Techniques That <span className="text-gradient">Set Us Apart</span></h3>
            <p>Proprietary methodologies developed exclusively for the Cambodian market</p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="technique-card__content">
                  <h4 className="technique-card__title">{technique.title}</h4>
